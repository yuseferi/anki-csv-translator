...
const textReplacement_useRegex = false;
...
const textReplacementRules = {
    'Apple': 'Banana',
    'www.ldoceonline.com/search/english/direct/': 'cors.yuseferi.workers.dev/search/english/direct/',
    'www.ldoceonline.com/search/?q=': 'cors.yuseferi.workers.dev/search/?q=',
}
...
const scriptInjectionRules = {
    ...
    '<style type="text/css"> .onetrust-pc-dark-filter.ot-fade-in,div#onetrust-consent-sdk{display:none;} </style>': 2
};
...
const upstream = 'www.ldoceonline.com';
...
const http_response_headers_set = {
    ...
    'Content-Security-Policy': "frame-ancestors 'self' https://ankiuser.net http://127.0.0.1:* 127.0.0.1:* localhost:* file://* https://www.w3schools.com", // Chrome, Firefox, etc.
...
async function fetchAndApply(request) {
    ...
    if (blocked_regions.includes(region) || blocked_ip_addresses.includes(ip_address)) {
        ...
        new_response_headers.set("Set-Cookie","flavor=choco; SameSite=None; Secure");
        ...
        //original_text = original_text.replace("https://geolocation.onetrust.com/cookieconsentpub/v1/geo/location/geofeed","_");
        //original_text = original_text.replace("https://cdn.cookielaw.org/scripttemplates/otSDKStub.js","_");
        //original_text = original_text.replace("document.head.appendChild(otCCPAiab);","_");
        //original_text = original_text.replace("onetrust-banner-sdk","q");
        //original_text = original_text.replace("onetrust-pc-dark-filter ot-fade-in","q");
        //original_text = original_text.replace("www.ldoceonline.com/search/english/direct/","cors.yuseferi.workers.dev/search/english/direct/");
//            'www.ldoceonline.com/search/english/direct/': 'cors.yuseferi.workers.dev/search/english/direct/',
        //  'www.ldoceonline.com/search/?q=': 'cors.yuseferi.workers.dev/search/?q=',

        var html = original_text;
        html = replaceText(html);
        original_text = injectScripts(html);
